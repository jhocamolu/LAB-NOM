...
{
    public class CrearComplementoPlantillaRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var elemento = dbContexto.ComplementoPlantillas.FirstOrDefault(x => x.Nombre == Nombre);
                if (elemento != null)
                {
