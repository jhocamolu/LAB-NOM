...
{
    public class ActualizarCalendarioRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var existefecha = dbContexto.Calendarios.FirstOrDefault(x => x.Fecha == Fecha && x.Id != Id);
                if (existefecha != null)
                {
                    errores.Add(new ValidationResult(
