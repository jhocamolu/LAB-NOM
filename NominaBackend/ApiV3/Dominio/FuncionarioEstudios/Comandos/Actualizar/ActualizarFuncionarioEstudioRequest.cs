...
{
    public class ActualizarFuncionarioEstudioRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                if (AnioDeInicio < DateTime.Parse("1954-01-01"))
                {
                    errores.Add(new ValidationResult(
                            $"El año de inicio no puede ser menor a 1974-01-01.",
                            new[] { "AnioDeInicio" }));
                }
