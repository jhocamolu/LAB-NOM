...
/// <summary>
/// Clase encargada de realizar las validaciones para actualziar la entidad Funcionarios
/// </summary>

namespace ApiV3.Dominio.Funcionarios.Comandos.Actualizar
{
    public class ActualizarFuncionarioRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
