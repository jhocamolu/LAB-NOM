...
/// <summary>
/// Clase encargada de realizar las validaciones para crear registros de la entidad Funcionarios
/// </summary>

namespace ApiV3.Dominio.Funcionarios.Comandos.Crear
{
    public class CrearFuncionarioRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones   
        #region DATOSBASICOS
        #region PrimerNombre
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                //EstadoEmpleadoId se valida en en Handler
                ...
                var numeroDocumento = contexto.Funcionarios.FirstOrDefault(x => x.NumeroDocumento == NumeroDocumento);
                ...
                if (Nit != null)
                {
                    var nit = contexto.Funcionarios.FirstOrDefault(x => x.Nit == Nit);
                    if (nit != null)
                    {
                ...
                if (ClaseLibretaMilitarId != null)
                {
                    ...
                    var numeroLibreta = contexto.Funcionarios.FirstOrDefault(x => x.NumeroLibreta == NumeroLibreta);
