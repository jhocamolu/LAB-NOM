...
namespace ApiV3.Dominio.AplicacionExternaCargos.Comandos.Actualizar
{
    ...
    public class ActualizarAplicacionExternaCargoRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
            ...
            try
            {
                ...
                if (banderaCargoAsociado == true)
                {
                    errores.Add(new ValidationResult(
                        $"El cargo dependiente con el centro operativo que intentas guardar, ya tiene asociado un cargo aprobador para esta aprobación y autorización. Por favor revisa.",
                        new[] { "snackbar" }));
                }
                #endregion
