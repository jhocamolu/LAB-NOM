...
{
    public class CrearSustitutoRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validacion
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                {
                    errores.Add(new ValidationResult("La fecha inicial no puede ser menor que la fecha actual.",
                            new[] { "FechaInicio" }));
                }
                #endregion
                #region FechaFinal
