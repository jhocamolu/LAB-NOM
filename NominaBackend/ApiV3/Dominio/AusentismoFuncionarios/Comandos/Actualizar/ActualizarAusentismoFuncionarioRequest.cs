...
{
    public class ActualizarAusentismoFuncionarioRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validacion 
        ...
        [EnumDataType(typeof(EstadoAusentismo), ErrorMessage = "No es un estado valido.")]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #region existeID
                var existeID = dbContexto.AusentismoFuncionarios.FirstOrDefault(x => x.Id == Id);
                if (existeID == null)
                {
