...
{
    public class CrearTipoEmbargoRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validacion 
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var elemento = dbContexto.TipoEmbargos.FirstOrDefault(x => x.Nombre == Nombre);
                if (elemento != null)
                {
                ...
                {
                    var validarTipoEmbargo = dbContexto.TipoEmbargoConceptoNominas.FirstOrDefault(x => x.ConceptoNominaId == ConceptoNominaId);
                    ...
                    //Valida el conceto de nómina tipo de deducción
                ...
                var validaPrioridad = dbContexto.TipoEmbargos.FirstOrDefault(x => x.Prioridad == Prioridad);
