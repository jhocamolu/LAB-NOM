...
{
    public class CrearActividadCentroCostoRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #endregion
                #region Centro Costo
                var repiteCentroCosto = dbContexto.ActividadCentroCostos.FirstOrDefault(x => x.MunicipioId == MunicipioId && x.CentroCostoId == CentroCostoId);
