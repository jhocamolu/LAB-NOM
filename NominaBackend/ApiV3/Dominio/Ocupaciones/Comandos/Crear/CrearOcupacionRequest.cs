...
{
    public class CrearOcupacionRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var elemento = dbContexto.Ocupaciones.SingleOrDefault(x => x.Codigo == Codigo);
                if (elemento != null)
                {
                ...
                //Valida que código sea único
                var elementoNombre = dbContexto.Ocupaciones.SingleOrDefault(x => x.Nombre == Nombre);
