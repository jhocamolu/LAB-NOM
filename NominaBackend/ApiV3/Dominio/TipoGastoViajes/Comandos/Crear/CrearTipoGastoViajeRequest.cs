...
{
    public class CrearTipoGastoViajeRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var validaTipoConcepto = dbContexto.TipoGastoViajes.FirstOrDefault(x => x.Tipo == Tipo &&
