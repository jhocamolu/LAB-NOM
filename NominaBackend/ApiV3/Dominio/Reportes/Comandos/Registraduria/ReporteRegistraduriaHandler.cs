...
{
    public class ReporteRegistraduriaHandler : Peticion, IRequestHandler<ReporteRegistraduriaRequest, CommandResult>
    {
        private readonly string host;
        const string ALIAS = "Registraduria";

        public ReporteRegistraduriaHandler(IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(ReporteRegistraduriaRequest request, CancellationToken cancellationToken)
        {
            try
            {
