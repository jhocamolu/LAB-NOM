...
{
    public class ReporteAusentismoLaboralHandler : IRequestHandler<ReporteAusentismoLaboralRequest, CommandResult>
    {
        private IConfiguration configuration;
        private IPeticionService peticion;
        private readonly string host;
        const string ALIAS = "AusentismoLaboral";

        public ReporteAusentismoLaboralHandler(IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(ReporteAusentismoLaboralRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                parametros = new
                {
                    ...
                    ClaseAusentismo = request.ClaseAusentismoId,
