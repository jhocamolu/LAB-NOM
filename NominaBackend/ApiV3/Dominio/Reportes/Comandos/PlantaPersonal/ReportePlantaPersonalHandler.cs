...
namespace ApiV3.Dominio.Reportes.Comandos.PlantaPersonal
{
    public class ReportePlantaPersonalHandler : Peticion, IRequestHandler<ReportePlantaPersonalRequest, CommandResult>
    {

        private readonly string host;
        const string ALIAS = "PlantaPersonal";

        public ReportePlantaPersonalHandler(IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(ReportePlantaPersonalRequest request, CancellationToken cancellationToken)
        {
            try
            {
