...
{
    public class ReporteBeneficioCorporativoHandler : IRequestHandler<ReporteBeneficioCorporativoRequest, CommandResult>
    {
        private IConfiguration configuration;
        private IPeticionService peticion;
        private readonly string host;
        const string ALIAS = "BeneficioCorporativo";

        public ReporteBeneficioCorporativoHandler(IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(ReporteBeneficioCorporativoRequest request, CancellationToken cancellationToken)
        {
