...
{
    public class ReporteFamiliaresFuncionarioHandler : Peticion, IRequestHandler<ReporteFamiliaresFuncionarioRequest, CommandResult>
    {
        const string ALIAS = "FamiliaresFuncionario";

        public ReporteFamiliaresFuncionarioHandler(IConfiguration configuration, IPeticionService peticion)
        {
            this.configuration = configuration;
            this.peticion = peticion;
        }

        public async Task<CommandResult> Handle(ReporteFamiliaresFuncionarioRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    TipoParentescoId = request.TipoParentescoId,
