...
{
    public class ReporteMaestroFuncionarioHandler : Peticion, IRequestHandler<ReporteMaestroFuncionarioRequest, CommandResult>
    {
        const string ALIAS = "MaestroFuncionarios";

        public ReporteMaestroFuncionarioHandler(IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(ReporteMaestroFuncionarioRequest request, CancellationToken cancellationToken)
        {
            try
            {
