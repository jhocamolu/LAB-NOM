...
{
    public class CrearNomenclaturaDianRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var element = dbContext.NomenclaturaDians.FirstOrDefault(x => x.Codigo == Codigo);
                if (element != null)
                {
