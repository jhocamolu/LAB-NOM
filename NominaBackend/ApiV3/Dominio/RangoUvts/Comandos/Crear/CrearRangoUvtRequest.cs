...
{
    public class CrearRangoUvtRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validacion
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #region Rango Existe
                var validaExiste = dbContexto.RangoUvts.FirstOrDefault(x => x.Desde == Desde &&
                                                                            x.Hasta == Hasta &&
                ...
                else
                {
                    ...
                    var validaRangoHastaCero = dbContexto.RangoUvts.FirstOrDefault(x => x.ValidoDesde == ValidoDesde &&
                    ...
                    {
                        var validaDentroDeRango = dbContexto.RangoUvts.FirstOrDefault(x => x.ValidoDesde == ValidoDesde &&
                ...
                if ((DateTime)ValidoDesde.Value.Date < DateTime.Now.Date)
                {
