...
{
    public class CrearTerceroRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                #region Nombre
                Tercero nombre = contexto.Terceros.FirstOrDefault(x => x.Nombre == Nombre);
                if (nombre != null)
                {
                ...
                #region Nit
                Tercero nit = contexto.Terceros.FirstOrDefault(x => x.Nit == Nit);
                if (nit != null)
                {
