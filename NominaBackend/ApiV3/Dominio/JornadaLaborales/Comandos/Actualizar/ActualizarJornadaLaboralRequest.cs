...
/// <summary>
/// Clase encargada de realizar las validaciones para  actualizar el modelo JornadaLaborales
/// </summary>

namespace ApiV3.Dominio.JornadaLaborales.Comandos.Actualizar
{
    public class ActualizarJornadaLaboralRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
