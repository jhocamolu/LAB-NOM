...
{
    public class ActualizarTipoAusentismoConceptoNominaRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #region Id
                var id = dbContexto.TipoAusentismoConceptoNominas.FirstOrDefault(x => x.Id == Id);
                if (id == null)
                {
                ...
                var elemento = dbContexto.TipoAusentismoConceptoNominas.FirstOrDefault(x => x.Id != Id &&
