...
{
    public class CrearTipoEmbargoConceptoNominaRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                {
                    var validarTipoEmbargo = dbContexto.TipoEmbargoConceptoNominas.FirstOrDefault(x => x.ConceptoNominaId == ConceptoNominaId && x.TipoEmbargoId == TipoEmbargoId);
