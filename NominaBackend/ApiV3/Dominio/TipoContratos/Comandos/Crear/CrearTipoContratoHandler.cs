...
namespace ApiV3.Dominio.TipoContratos.Comandos.Crear
{
    public class CrearTipoContratoHandler : IRequestHandler<CrearTipoContratoRequest, CommandResult>
    {
        ...
        public CrearTipoContratoHandler(NominaDbContext contexto, IConfiguration configuration, IPeticionService peticion)
        {
        ...
        public async Task<CommandResult> Handle(CrearTipoContratoRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                this.contexto.TipoContratos.Add(tipoContrato);
