...
{
    public class CrearInformacionFamiliarRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var element = dbContexto.InformacionFamiliares.FirstOrDefault(x => x.NumeroDocumento == NumeroDocumento);
                if (element != null)
                {
