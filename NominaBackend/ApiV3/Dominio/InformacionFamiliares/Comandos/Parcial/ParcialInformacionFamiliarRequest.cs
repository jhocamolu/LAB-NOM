...
{
    public class ParcialInformacionFamiliarRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        [MaxLength(ErrorMessage = ConstantesErrores.Maximo + " 100")]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                if (SexoId != null)
                {
                    var existeGenero = dbContexto.Sexos.FirstOrDefault(x => x.Id == SexoId);
                ...
                if (FechaNacimiento != fechaVacia && FechaNacimiento != null)
                {
