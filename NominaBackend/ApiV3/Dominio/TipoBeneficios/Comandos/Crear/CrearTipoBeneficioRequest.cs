...
{
    public class CrearTipoBeneficioRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #region Nombre
                var validaUnico = dbContexto.TipoBeneficios.FirstOrDefault(x => x.Nombre == Nombre);
                if (validaUnico != null)
                {
