...
{
    public class CrearInformacionBasicaRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                #region Nit
                var informacion = contexto.InformacionBasicas.FirstOrDefault(x => x.Nit == Nit);
                if (informacion != null)
                {
        ...
        #endregion Validaciones_Manuales
    }
}
