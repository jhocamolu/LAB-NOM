...
namespace ApiV3.Dominio.Embargos.Comandos.Crear
{
    ...
    public class CrearEmbargoRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        [Required(ErrorMessage = ConstantesErrores.Requerido)]
        [RegularExpression(@"^[" + ConstantesExpresionesRegulares.Numerico + "]*$", ErrorMessage = ConstantesErrores.Numerico)]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                {
                    var numeroProceso = contexto.Embargos.FirstOrDefault(x => x.NumeroProceso == NumeroProceso);
                ...
                if (Prioridad != null)
                {
                    ...
                    //foreach (var embargoCreado in embargoCreados)
