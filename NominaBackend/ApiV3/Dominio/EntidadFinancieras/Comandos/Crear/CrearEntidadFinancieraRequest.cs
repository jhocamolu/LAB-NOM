...
{
    public class CrearEntidadFinancieraRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var elemento = dbContexto.EntidadFinancieras.FirstOrDefault(x => x.Codigo == Codigo);
                if (elemento != null)
                {
                ...
                var validaNit = dbContexto.EntidadFinancieras.FirstOrDefault(x => x.Nit == Nit);
                if (validaNit != null)
                {
                    errores.Add(new ValidationResult(
                ...
                var validaNombre = dbContexto.EntidadFinancieras.FirstOrDefault(x => x.Nombre == Nombre);
                ...
                {
                    var existeEntidadPorDefecto = dbContexto.EntidadFinancieras.FirstOrDefault(x => x.EntidadPorDefecto == true);
