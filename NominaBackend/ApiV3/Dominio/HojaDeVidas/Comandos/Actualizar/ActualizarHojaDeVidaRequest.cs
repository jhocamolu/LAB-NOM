...
{
    public class ActualizarHojaDeVidaRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                if (SexoId != null)
                {
                    ...
                    if (genero == null)
                    {
                        errores.Add(new ValidationResult("El género que intentas guardar no existe.", new[] { "SexoId" }));
                    }
                }
                #endregion
                ...
                var numeroDocumento = contexto.HojaDeVidas.FirstOrDefault(x => x.Id != Id && x.NumeroDocumento == NumeroDocumento);
                ...
                if (Nit != null)
                {
                    var nit = contexto.HojaDeVidas.FirstOrDefault(x => x.Id != Id && x.Nit == Nit);
                    if (nit != null)
                    {
                ...
                if (ClaseLibretaMilitarId != null)
                {
                    ...
                    var numeroLibreta = contexto.HojaDeVidas.FirstOrDefault(x => x.Id != Id && x.NumeroLibreta == NumeroLibreta);
