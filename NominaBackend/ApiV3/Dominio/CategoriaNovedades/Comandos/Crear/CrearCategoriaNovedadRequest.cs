...
{
    public class CrearCategoriaNovedadRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var nombreExiste = dbContexto.CategoriaNovedades.FirstOrDefault(x => x.Nombre == Nombre && x.EstadoRegistro == EstadoRegistro.Activo);
                ...
                if (ConceptoNominaId != null)
                {
                    var conceptoExiste = dbContexto.CategoriaNovedades.FirstOrDefault(x => x.ConceptoNominaId == ConceptoNominaId && x.EstadoRegistro == EstadoRegistro.Activo);
