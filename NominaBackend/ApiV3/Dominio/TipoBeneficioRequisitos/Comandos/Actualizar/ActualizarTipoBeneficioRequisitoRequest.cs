...
{
    public class ActualizarTipoBeneficioRequisitoRequest : IRequest<CommandResult>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var validatipoSoporte = dbContexto.TipoBeneficioRequisitos.FirstOrDefault(x => x.TipoSoporteId == TipoSoporteId && x.TipoBeneficioId == TipoBeneficioId && x.Id != Id);
