...
namespace ApiV3.Migrations
{
    ...
    [Migration("20200814215133_sprint14011")]
    partial class sprint14011
    {
            ...
            modelBuilder.Entity("ApiV3.Models.Candidato", b =>
                {
                    ...
                    b.HasIndex("RequisicionPersonalId", "HojaDeVidaId")
                        .IsUnique();
                    ...
                    b.HasCheckConstraint("CK_Candidato_Estado", "([Estado]='Postulado' OR [Estado]='Descartado' OR [Estado]='Competente' OR [Estado]='Elegible' OR [Estado]='NoApto' OR [Estado]='Seleccionado' OR [Estado]='Reprobado')");
                });
