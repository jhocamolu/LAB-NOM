...
namespace ApiV3.Migrations
{
    ...
    [Migration("20200716002434_sprint130012")]
    partial class sprint130012
    {
            ...
            modelBuilder.Entity("ApiV3.Models.AplicacionExternaCargo", b =>
                {
                    ...
                    b.Property<int>("CargoIndependienteId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CargoIndependienteId");
                    ...
                    b.HasCheckConstraint("CK_AplicacionExternaCargo_Tipo", "([Tipo]='Aprobacion' OR [Tipo]='Autorizacion')");
                });
            ...
            modelBuilder.Entity("ApiV3.Models.AplicacionExternaCargoDependiente", b =>
                {
                    ...
                    b.Property<int>("CargoDependienteId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiV3.Models.Contrato", b =>
                {
                    ...
                    b.Property<string>("ProcedimientoRetencio")
                        .IsRequired()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("ApiV3.Models.NotificacionDestinatario", b =>
                {
                    ...
                    b.ToTable("NotificacionDestinatario");
            ...
            modelBuilder.Entity("ApiV3.Models.NotificacionPlantilla", b =>
                {
                    ...
                    b.ToTable("NotificacionPlantilla");
            ...
            modelBuilder.Entity("ApiV3.Models.RequisicionPersonal", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_RequisicionPersonal_Estado", "([estado]='Anulada' OR [estado]='Aprobada' OR [estado]='Autorizacion' OR [estado]='Cancelada' OR [estado]='Cubierta' OR [estado]='Rechazada' OR [estado]='Revisada' OR [estado]='Solicitada')");
            ...
            modelBuilder.Entity("ApiV3.Models.SolicitudVacacion", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_SolicitudVacaciones_Estado", "([Estado]='Aprobada' OR [Estado]='Autorizada' OR [Estado]='Cancelada' OR [Estado]='EnCurso' OR [Estado]='Interrumpida' OR [Estado]='Rechazada' OR [Estado]='Solicitada'  OR [Estado]='Terminada')");
                });
            ...
            modelBuilder.Entity("ApiV3.Models.TipoContrato", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_TipoContrato_Clase", "([Clase]='NoIntegral' OR [Clase]='Integral' OR [Clase]='Aprendizaje' OR [Clase]='Practicante')");
                });
            ...
            modelBuilder.Entity("ApiV3.Models.AplicacionExternaCargo", b =>
                {
                    ...
                    b.HasOne("ApiV3.Models.Cargo", "CargoIndependiente")
                        .WithMany()
                        .HasForeignKey("CargoIndependienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApiV3.Models.AplicacionExternaCargoDependiente", b =>
                {
                    ...
                    b.HasOne("ApiV3.Models.Cargo", "CargoDependiente")
                        .WithMany()
                        .HasForeignKey("CargoDependienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
