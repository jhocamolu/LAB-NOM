...
namespace ApiV3.Migrations
{
    ...
    [Migration("20200810202914_sprint14006")]
    partial class sprint14006
    {
            ...
            modelBuilder.Entity("ApiV3.Models.Candidato", b =>
                {
                    ...
                    b.HasIndex("RequisicionPersonalId");
                    ...
                    b.HasCheckConstraint("CK_Candidato_Estado", "([Estado]='Postulado' OR [Estado]='Descartado' OR [Estado]='Competente' OR [Estado]='Elegible' OR [Estado]='NoApto' OR [Estado]='Seleccionado')");
                });
            ...
            modelBuilder.Entity("ApiV3.Models.HojaDeVidaExperienciaLaboral", b =>
                {
                    ...
                    b.ToTable("HojaDeVidaExperienciaLaboral");
