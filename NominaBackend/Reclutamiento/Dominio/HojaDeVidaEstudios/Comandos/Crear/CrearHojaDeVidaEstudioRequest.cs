...
{
    public class CrearHojaDeVidaEstudioRequest : IRequest<CommandResult>, IValidatableObject
    {
        #region Validaciones
        ...
        #region Validacion Estudioa
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            List<ValidationResult> errores = new List<ValidationResult>();
            var dbContexto = (ReclutamientoDbContext)validationContext.GetService(typeof(ReclutamientoDbContext));
            try
            {
                #region HojaDeVidaId
                ...
                /*if (EstadoEstudio == EstadoEstudio.Culminado)
                {
                    if (FechaFin == null)
                    {
