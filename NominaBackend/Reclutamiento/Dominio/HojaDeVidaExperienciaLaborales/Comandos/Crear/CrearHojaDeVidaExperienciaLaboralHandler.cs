...
namespace Reclutamiento.Dominio.HojaDeVidaExperienciaLaborales.Comandos.Crear
{
    public class CrearHojaDeVidaExperienciaLaboralHandler : Peticion, IRequestHandler<CrearHojaDeVidaExperienciaLaboralRequest, CommandResult>
    {
        ...
        public CrearHojaDeVidaExperienciaLaboralHandler(IConfiguration configuration, IPeticionService peticion, IHttpContextAccessor httpContextAccessor, UserManager<UsuarioAplicacion> userManager, ReclutamientoDbContext contexto)
        {
        ...
        public async Task<CommandResult> Handle(CrearHojaDeVidaExperienciaLaboralRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (tokenPortal != "")
                {
                    ...
                    var list = await this.EnviarServicios($"{host}/api/hojadevidaexperiencialaborales", request, usuario.TokenGhestic);
