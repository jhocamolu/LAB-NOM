import { Component, OnDestroy, OnInit, ViewChild, ViewEncapsulation, HostListener, Input } from '@angular/core';
...
export class NavbarVerticalStyle2Component implements OnInit, OnDestroy {
    ...
    @Input('activeHoover') activeHoover: any;
    ...
    toggleSidebarFolded(): void {
        ...
        console.log( this._fuseSidebarService.getSidebar('navbar').folded );
    ...
    onMouseLeave(): void {
        if (this._fuseSidebarService.getSidebar('navbar').folded) {
            this.newImage = this.activeHoover;
        }
    }
