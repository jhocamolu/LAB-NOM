...
@Component({
  selector: 'modal-estados-competente',
  templateUrl: './competente.component.html',
  styleUrls: ['./competente.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class CompetenteComponent implements OnInit {

  form: FormGroup;
  submit: boolean;

  constructor(
    public dialogRef: MatDialogRef<CompetenteComponent>,
    @Inject(MAT_DIALOG_DATA) public element: any,
    private _formBuilder: FormBuilder,
    private _alcanosSnackBar: AlcanosSnackBarService,
    private _service: EstadosService,
    private _service2: PrimerFiltroListarService,
  ) {
  ...
  validate(formGroup: FormGroup): ValidatorFn {
    ...
    if (value.estado === 'Descartado' && !value.justificacion) {
