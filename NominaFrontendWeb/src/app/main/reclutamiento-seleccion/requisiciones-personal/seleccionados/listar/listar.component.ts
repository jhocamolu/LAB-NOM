...
import { SeleccionadosFiltroComponent } from '../filtro/filtro.component';
import { SeleccionadosListarService } from './listar.service';
...
@Component({
  selector: 'seleccionados-listar',
  templateUrl: './listar.component.html',
  styleUrls: ['./listar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class SeleccionadosListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private _serviceC: CandidatosListarService,
  ...
  descartadoHandle(event, element): void {
    const dialogRef = this._matDialog.open(DescartadoComponent, {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === true) {
        ...
        this._serviceC.buildFilter(queryParams);
  ...
  filtroHandle(event): void {
    const dialogRef = this._matDialog.open(SeleccionadosFiltroComponent, {
