...
import { PrimerFiltroListarService } from '../listar/listar.service';

@Component({
  selector: 'primer-filtro-filtro',
  templateUrl: './filtro.component.html',
  styleUrls: ['./filtro.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PrimerFiltroComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PrimerFiltroComponent>,
