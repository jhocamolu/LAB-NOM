...
import { PrimerFiltroComponent } from '../filtro/filtro.component';
import { PrimerFiltroListarService } from './listar.service';
...
@Component({
  selector: 'primer-filtro-listar',
  templateUrl: './listar.component.html',
  styleUrls: ['./listar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class PrimerFiltroListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private _service: PrimerFiltroListarService,
  ...
  competenteHandle(event, element): void {
    const dialogRef = this._matDialog.open(ElegirCandidatoComponent, {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === true) {
        ...
        this._service1.getCandidatos();
        this._service2.getCandidatos();
  ...
  filtroHandle(event): void {
    const dialogRef = this._matDialog.open(PrimerFiltroComponent, {
