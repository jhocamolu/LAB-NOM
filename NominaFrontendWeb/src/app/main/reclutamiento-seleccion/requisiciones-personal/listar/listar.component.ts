...
export class ListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  displayedColumns: string[] = ['fechaCreacion', 'funcionarioSolicitante/criterioBusqueda', 'cargoDependenciaSolicitante/cargo/nombre', 'cargoDependenciaSolicitado/cargo/nombre', 'estado', 'acciones'];


  estadoRequisicion: any = estadoRequisicionPersonalAlcanos;
  ...
  crearHandle(event): void {
    this._router.navigate(
      ['/reclutamiento-seleccion/requisiciones-personal/crear'],
    );
  }
