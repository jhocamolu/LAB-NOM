...
import { SegundoFiltroListarService } from '../listar/listar.service';

@Component({
  selector: 'segundo-filtro-filtro',
  templateUrl: './filtro.component.html',
  styleUrls: ['./filtro.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class SegundoFiltroComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<SegundoFiltroComponent>,
