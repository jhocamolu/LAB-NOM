...
@Component({
  selector: 'plantilla-complementos-listar',
...
export class ListarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  displayedColumns: string[] = ['nombre', 'tipo', 'grupoDocumentoId', 'estadoRegistro', 'acciones'];
  ...
  constructor(
    ...
    this.arrayPermisos = this._permisos.permisosStorage('ComplementoPlantillas_');
  }
