...
export class FiltroComponent implements OnInit {
  ...
  form: FormGroup;
  conceptoRelacionadosOptions: any[] = [];
  ...
  constructor(
    ...
    this.form = this._formBuilder.group({
      ...
      conceptoNominaId: [this.element.conceptoNominaId],
    });
  }
  ...
  ngOnInit(): void  {
    ...
    this.selectConceptoRelacionados();
  }
  
  public selectConceptoRelacionados(): void {
    this._service.getConceptoRelacionadosLista().then(
      (resp: any[]) => {
        this.conceptoRelacionadosOptions = resp;
      }
    );
  }
