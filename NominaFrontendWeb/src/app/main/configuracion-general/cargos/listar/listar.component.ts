...
export class ListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  displayedColumns: string[] = ['codigo', 'nombre', 'nivelCargo/nombre', 'clase', 'estadoRegistro', 'acciones'];
