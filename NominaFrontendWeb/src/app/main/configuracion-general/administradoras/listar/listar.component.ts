...
@Component({
  selector: 'administradoras-listar',
...
export class ListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  displayedColumns: string[] = ['codigo', 'nombre', 'nit', 'tipoAdministradora/nombre', 'estadoRegistro', 'acciones'];
  ...
  constructor(
    ...
    this.arrayPermisos = this._permisos.permisosStorage('Administradoras_');
    ...
    dialogRef.afterClosed().subscribe(confirm => {
      if (confirm) {
        ...
        this._service.activo(id, bool).then(result => {
          this._service.getAdministradoras();
