...
export class FiltroComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this._formBuilder.group({
      codigo: [this.element.codigo, [AlcanosValidators.numerico, AlcanosValidators.maxLength(3)]],
      nombre: [this.element.nombre, [AlcanosValidators.alfabetico, AlcanosValidators.maxLength(60)]],
      nacionalidad: [element.nacionalidad, [Validators.pattern('^[A-Za-z\\s/]*$'), AlcanosValidators.maxLength(100)]],
    });
  }
