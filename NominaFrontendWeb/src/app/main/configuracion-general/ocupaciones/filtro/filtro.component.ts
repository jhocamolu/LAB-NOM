...
export class FiltroComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this._formBuilder.group({
      codigo: [this.element.codigo, [AlcanosValidators.numerico, AlcanosValidators.maxLength(4)]],
      nombre: [this.element.nombre, [AlcanosValidators.alfabetico, AlcanosValidators.maxLength(200)]],
      });
  }
