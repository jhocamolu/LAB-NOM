...
export class CrearComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this._formBuilder.group({
      codigo: [null, [Validators.required, AlcanosValidators.numerico, AlcanosValidators.maxLength(4)]],
      nombre: [null, [Validators.required, AlcanosValidators.alfabetico, AlcanosValidators.maxLength(200)]],
    });
    this.submit = false;
  }
