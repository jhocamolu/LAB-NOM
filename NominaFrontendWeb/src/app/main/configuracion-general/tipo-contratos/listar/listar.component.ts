...
import { claseTipoContrato } from '@alcanos/constantes/clase-tipo-contrato';
import { PermisosrService } from '@alcanos/services/permisos/permisos.service';
import { HttpErrorResponse } from '@angular/common/http';
import { AlcanosSnackBarService } from '@alcanos/services/snackbar/snackbar.service';

@Component({
  selector: 'tipo-prorrogas-listar',
...
export class ListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  clase = claseTipoContrato;

  dataSource: FilesDataSource | null;
  displayedColumns: string[] = ['nombre', 'clase', 'cantidadProrrogas', 'duracionMaxima', 'terminoIndefinido', 'estadoRegistro', 'acciones'];
  ...
  constructor(
    ...
    this.arrayPermisos = this._permisos.permisosStorage('TipoContratos_');
  ...
  crearHandle(event): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === true) {
        this._service.getTipoContratos(this._service.urlFilters);
      }
    });
  }
