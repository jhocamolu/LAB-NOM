...
export class CrearComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this._formBuilder.group({
      codigo: [null, [Validators.required, AlcanosValidators.alfanumerico, AlcanosValidators.maxLength(4)]],
      nombre: [null, [Validators.required, AlcanosValidators.maxLength(255)]],
    });
    this.submit = false;
  }
