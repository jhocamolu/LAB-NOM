...
import { AprobarFamiliarService } from './aprobar.service';
...
@Component({
  selector: 'funcionario-familiar-aprobar',
  templateUrl: './aprobar.component.html',
  styleUrls: ['./aprobar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class AprobarFamiliarComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AprobarFamiliarComponent>,
    @Inject(MAT_DIALOG_DATA) public element: any,
    private _formBuilder: FormBuilder,
    private _alcanosSnackBar: AlcanosSnackBarService,
    private _service: AprobarFamiliarService,
  ) {
