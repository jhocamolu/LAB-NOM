...
import { AprobarExperienciaService } from './aprobar.service';
...
@Component({
  selector: 'funcionario-experiencia-aprobar',
  templateUrl: './aprobar.component.html',
  styleUrls: ['./aprobar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class AprobarExperienciaComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AprobarExperienciaComponent>,
    @Inject(MAT_DIALOG_DATA) public element: any,
    private _formBuilder: FormBuilder,
    private _alcanosSnackBar: AlcanosSnackBarService,
    private _service: AprobarExperienciaService,
  ) {
