...
import { AprobadoresListarService } from '../listar/listar.service';
import { MatPaginator, MatSort, PageEvent, Sort } from '@angular/material';
import { DataSource } from '@angular/cdk/table';
import { Observable, merge } from 'rxjs';
import { map } from 'rxjs/operators';
import { AprobadoresMostrarService } from './mostrar.service';

@Component({
  selector: 'aprobaciones-aprobadores-mostrar',
  templateUrl: './mostrar.component.html',
  styleUrls: ['./mostrar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class AprobadorMostrarComponent implements OnInit {
  ...
  constructor(
    private _service: AprobadoresMostrarService,
    public dialogRef: MatDialogRef<AprobadorMostrarComponent>,
