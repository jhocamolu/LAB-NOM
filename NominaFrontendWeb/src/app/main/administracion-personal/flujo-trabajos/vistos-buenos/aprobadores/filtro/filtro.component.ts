...
@Component({
  selector: 'aprobaciones-aprobadores-filtro',
  templateUrl: './filtro.component.html',
  styleUrls: ['./filtro.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class AprobadoresFiltroComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AprobadoresFiltroComponent>,
