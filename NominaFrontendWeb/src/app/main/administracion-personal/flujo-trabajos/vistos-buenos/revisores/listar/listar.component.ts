...
import { RevisoresFiltroComponent } from '../filtro/filtro.component';
import { RevisoresFormularioComponent } from '../formulario/formulario.component';
import { RevisorMostrarComponent } from '../mostrar/mostrar.component';
import { RevisoresListarService } from './listar.service';
import { FormularioComponent } from '../../formulario/formulario.component';

@Component({
  selector: 'revisores-aprobadores-listar',
  templateUrl: './listar.component.html',
  styleUrls: ['./listar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class RevisoresListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(
    private _service: RevisoresListarService,
  ...
  filtroHandle(event): void {
    const dialogRef = this._matDialog.open(RevisoresFiltroComponent, {
  ...
  revisorHandle(event, element?): void {
    const dialogRef = this._matDialog.open(RevisoresFormularioComponent, {
  ...
  revisorEditarHandle(event, element: any): void {
    const dialogRef = this._matDialog.open(RevisoresFormularioComponent, {
      panelClass: 'modal-dialog',
      data: {
        element: element,
        aplicacionExternaId: this._service.id,
        aplicacioneExterna: this._formularioCompoenent.form,
      },
      disableClose: true
    });
    dialogRef.afterClosed().subscribe(result => {
  ...
  mostrarRevisorHandle(event, element): void {
    const dialogRef = this._matDialog.open(RevisorMostrarComponent, {
