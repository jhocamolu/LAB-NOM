...
import { AutorizadoresFiltroComponent } from '../filtro/filtro.component';
import { AutorizadoresFormularioComponent } from '../formulario/formulario.component';
import { AutorizadorMostrarComponent } from '../mostrar/mostrar.component';
import { AutorizadoresListarService } from './listar.service';
import { FormularioComponent } from '../../formulario/formulario.component';

@Component({
  selector: 'aprobadores-autorizadores-listar',
  templateUrl: './listar.component.html',
  styleUrls: ['./listar.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None,
})
export class AutorizadoresListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  filtroHandle(event): void {
    const dialogRef = this._matDialog.open(AutorizadoresFiltroComponent, {
  ...
  autorizadorHandle(event, element?): void {
    const dialogRef = this._matDialog.open(AutorizadoresFormularioComponent, {
  ...
  autorizadorEditarHandle(event, element: any): void {
    const dialogRef = this._matDialog.open(AutorizadoresFormularioComponent, {
      panelClass: 'modal-dialog',
      data: element,
      disableClose: true
  ...
  mostrarAutorizadorHandle(event, element): void {
    const dialogRef = this._matDialog.open(AutorizadorMostrarComponent, {
