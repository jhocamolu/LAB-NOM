...
export class ListarComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  displayedColumns: string[] = ['funcionario/numeroDocumento', 'funcionario/primerNombre', 'tipoEmbargo/nombre', 'estado', 'acciones'];
  ...
  urlLink(event): any {
    return this._router.navigate(['/novedades/embargos/crear']);
  }
