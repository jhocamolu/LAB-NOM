...
import { CrearAusentismoLaboralComponent } from './crear.component';
...
const routes: Routes = [
  {
    path: '**',
    component: CrearAusentismoLaboralComponent,
...
@NgModule({
  declarations: [ CrearAusentismoLaboralComponent ],
  imports: [
...
export class AusentismoLaboralModule { }
