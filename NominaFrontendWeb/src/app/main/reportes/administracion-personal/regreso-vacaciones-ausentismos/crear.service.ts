...
export class CrearRegresoVacacionesAusentismosService {
    ...
    crear(dato: any): Promise<any> {
        return new Promise((resolve, reject) => {
            this._httpClient.post(`${environmentAlcanos.configuracionGeneral}/reporte/RegresoVacacacionesAusentismos`, dato)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
