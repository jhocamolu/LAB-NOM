...
import { CrearRegresoVacacionesAusentismosService } from './crear.service';
...
@Component({
    selector: 'regreso-vacaciones-ausentismos-crear',
    templateUrl: './crear.component.html',
    styleUrls: ['./crear.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class CrearRegresoVacacionesAusentismosComponent implements OnInit {
    form: FormGroup;
    submit: boolean;
    ...
    constructor(
        ...
        private _service: CrearRegresoVacacionesAusentismosService
    ) {
