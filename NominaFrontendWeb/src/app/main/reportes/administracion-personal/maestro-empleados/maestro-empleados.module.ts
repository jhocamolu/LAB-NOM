...
import { CrearMaestroEmpleadosComponent } from './crear.component';
import { AdministracionPersonalGuard } from '../administracion-personal.guard';
const routes: Routes = [
  {
    path: '**',
    component: CrearMaestroEmpleadosComponent,
...
@NgModule({
  declarations: [ CrearMaestroEmpleadosComponent ],
  imports: [
...
export class MaestroEmpleadosModule { }
