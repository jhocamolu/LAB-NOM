...
import { CrearMaestroEmpleadosService } from './crear.service';
...
@Component({
    selector: 'maestro-empleados-crear',
    templateUrl: './crear.component.html',
    styleUrls: ['./crear.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class CrearMaestroEmpleadosComponent implements OnInit {
    form: FormGroup;
    submit: boolean;
    ...
    constructor(
        ...
        private _service: CrearMaestroEmpleadosService
    ) {
