...
import { CrearPlantaPersonalComponent } from './crear.component';
import { AdministracionPersonalGuard } from '../administracion-personal.guard';
const routes: Routes = [
  {
    path: '**',
    component: CrearPlantaPersonalComponent,
...
@NgModule({
  declarations: [ CrearPlantaPersonalComponent ],
  imports: [
...
export class PlantaPersonalModule { }
