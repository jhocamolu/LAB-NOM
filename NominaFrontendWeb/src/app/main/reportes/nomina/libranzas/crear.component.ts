...
import { CrearLibranzaService } from './crear.service';
...
@Component({
    selector: 'libranza-crear',
    templateUrl: './crear.component.html',
    styleUrls: ['./crear.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class CrearLibranzaComponent implements OnInit {
    form: FormGroup;
    submit: boolean;
    ...
    constructor(
        ...
        private _service: CrearLibranzaService
    ) {
