...
import { CuentasFormularioComponent } from './cuentas/formulario/formulario.component';
import { CuentasFiltroComponent } from './cuentas/filtro/filtro.component';
import { AsociadosComponent } from './asociados/asociados.component';
import { OrdenarComponent } from './cuentas/ordenar/ordenar.component';
...
@NgModule({
  declarations: [
    ...
    MostrarComponent,
    FormularioComponent,
    CuentasListarComponent,
    CuentasFormularioComponent,
    CuentasFiltroComponent,
    AsociadosComponent,
    OrdenarComponent
  ],
  imports: [
...
export class ConceptoNominasModule { }
